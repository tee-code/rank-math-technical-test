		...
		<div class="container">
			...
			<div class="col-sm-12 text-left">			
				<?php if ( has_custom_logo() ) : the_custom_logo(); else: ?>
      			<a href="<?php echo esc_url( home_url( '/' ) ); ?>"><div class="site-title" style="color:<?php echo "#". esc_attr($header_text_color);?>"><?php echo esc_html( get_bloginfo( 'name' ) ); ?></div>
      			<p class="site-description" style="color:<?php echo "#". esc_attr($header_text_color);?>"><?php echo esc_html( get_bloginfo( 'description' ) ); ?></p><?php endif; ?></a>
			</div>
			</div>
